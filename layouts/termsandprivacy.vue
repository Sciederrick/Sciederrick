        ...
        <header v-if="!navLoading" class="sticky top-0 inset-x-0 z-40 frosted-glass">        
            <nav class="flex flex-row justify-between items-center my-10 mx-4 lg:my-2 lg:px-16">
                <div>
                    ...
                    <NuxtLink :to="`/privacy`"
                        class="m-2 underline btn md:mx-6 lg:mx-8">Privacy&nbsp;policy</NuxtLink>|
                    <NuxtLink to="/terms" target="_blank"
                        class="m-2 underline btn md:mx-6 lg:mx-8">Terms&nbsp;of&nbsp;use</NuxtLink>
            ...
            <section class="relative">
                ...
                <div class="flex justify-between items-center pb-4">
                    <p class="pl-2 text-sm md:text-base">
                        ...
                        <span>Copyright &#169; {{ new Date().getFullYear() }} Derrick Mbarani</span>
                    </p>
