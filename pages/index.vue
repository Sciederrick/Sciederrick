...
const mProjects = useMyProjects();
const mExperience = useMyExperience();
const mCommunities = useMyCommunities();
	...
	<main class="px-5 lg:px-16">
		...
		<section class="py-8 md:py-16 lg:flex lg:justify-between" data-observed="true" id="experience">
			...
			<div class="pt-12 md:pt-4">
				<ul class="space-y-8">
					<li v-for="experience in mExperience" :key="experience">
						...
						<h2 class="out font-normal italic pb-10">{{ experience.position }}</h2>
					</li>
				</ul>
			</div>
		</section>
		...
		<section class="py-8 md:py-16 lg:flex lg:justify-between" data-observed="true" id="communities">
			...
			<div class="pt-12 md:pt-4 lg:order-1">
				<ul class="space-y-8">
					<li v-for="community in mCommunities">
						<p class="out text-2xl md:text-2xl md:max-w-xl">
						...
						<h2 class="out font-normal italic pb-10">{{ community.position }}</h2>
					</li>
				</ul>
			</div>
		</section>
