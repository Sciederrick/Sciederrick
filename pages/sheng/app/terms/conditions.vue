	...
	<section>
		<div class="container">
			...
			<p>
				...
				intellectual property rights related to it, still belong to Derrick Mbarani.
			</p>

			<p>
				Derrick Mbarani is committed to ensuring that the app is as useful and efficient as possible. For that
				reason, we reserve the right to make changes to the app or to charge for its services, at any time and
				for any reason. We will never charge you for the app or its services without making it very clear to you
				exactly what you’re paying for.
			</p>

			<p>
				The Sheng app stores and processes personal data that you have provided to us, to provide my Service.
				...
				the Sheng app won’t work properly or at all.
			</p>

			<p>
				You should be aware that there are certain things that Derrick Mbarani will not take responsibility for.
				Certain functions of the app will require the app to have an active internet connection. The connection
				can be Wi-Fi or provided by your mobile network provider, but Derrick Mbarani cannot take responsibility
			...
			<p>
				Along the same lines, Derrick Mbarani cannot always take responsibility for the way you use the app i.e.
				You need to make sure that your device stays charged – if it runs out of battery and you can’t turn it
				on to avail the Service, Derrick Mbarani cannot accept responsibility.
			</p>

			<p>
				With respect to Derrick Mbarani’s responsibility for your use of the app, when you’re using the app,
				...
				Derrick Mbarani accepts no liability for any loss, direct or indirect, you experience as a result of
				relying wholly on this functionality of the app.
			</p>

			<p>
				At some point, we may wish to update the app. The app is currently available on Android – the
				requirements for the system(and for any additional systems we decide to extend the availability of the
				app to) may change, and you’ll need to download the updates if you want to keep using the app. Derrick
				Mbarani does not promise that it will always update the app so that it is relevant to you and/or works
